<?php 
  ...
  $id = secureParamToSql($_GET['idNovedad']);
                        ...
                        <div class="col-sm-10 col-xs-8">
                            <nav class="main-nav">
                            	...
                            	<ul class="inline-list align-right uppercase"> 
                            		<li><a href="index.php#news">Volver</a></li>
                            	</ul>
                            </nav>
                        </div> 
                    </div> 
								...
								<div class="post-share">
									...
									<ul class="inline-list social-networks text-white align-center">									
										<li class="facebook-network">
											<a href="http://www.facebook.com/sharer/sharer.php?u=<?php echo _global_siteurl; ?>novedad.php?idNovedad=<?php echo $id; ?>"><i class="icon-182"></i></a>
										</li>
										<li class="twitter-network">
											<a href="https://twitter.com/home?status=<?php echo $row['titulo']; ?>: <?php echo _global_siteurl; ?>novedad.php?idNovedad=<?php echo $id; ?> (via @<?php echo $meta['twitter']; ?>)"><i class="icon-510"></i></a>
										</li>
										<li class="linkedin-network">
											<a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo _global_siteurl; ?>novedad.php?idNovedad=<?php echo $id; ?>&amp;title=<?php echo $row['titulo']; ?>"><i class="icon-297"></i></a>
										</li>
									</ul>
								</div>
								<div class="row">
												...
												<div class="row">
													<div class="col-md-8">
														<ul class="inline-list text-grey meta-list">
															...
															<!-- Aca podria ir el nombre de la emrpesa
															<li>by
					...
					<div class="col-md-3">
						<aside class="main-sidebar row" data-masonry=".widget">
							...
							<div class="widget widget-recent-posts col-md-12 col-sm-6">
								<h6 class="uppercase widget-title">Novedades recientes</h6>
								...
								<div class="widget-content style-alpha">
									<ul class="clean-list recent-posts-loop">
										...
										<li class="row row-fit">
											...
											<div class="col-sm-8">
												<a href="novedad.php?idNovedad=<?php echo $nov['idNovedad']; ?>"><b><?php echo $nov['titulo']; ?></b></a>
											</div>
										</li>
										<?php 
								            	}
