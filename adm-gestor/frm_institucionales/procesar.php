	...
	*/
	...
	if($_GET["action"] == "create")
	{
		...
		if($ins){
			...
			header('location: ../proceso.php?op=alta/de/institucionales&result=ok');

		} else {

			header('location: ../proceso.php?op=alta/de/institucionales&result=bad');
	...
	else if($_GET["action"] == "update")
	{
		...
		if($upd){
			...
			header('location: ../proceso.php?op=panel/institucionales&result=ok');

		} else {

			header('location: ../proceso.php?op=panel/institucionales&result=bad');
