	...
	*/
	...
	if($_GET["action"] == "create")
	{
		...
		if($ins){
			...
			header('location: ../proceso.php?op=alta/de/novedades&result=ok');

		} else {

			header('location: ../proceso.php?op=alta/de/novedades&result=bad');
	...
	else if($_GET["action"] == "update")
	{
		...
		if($upd){
			...
			header('location: ../proceso.php?op=panel/novedades&result=ok');

		} else {

			header('location: ../proceso.php?op=panel/novedades&result=bad');
